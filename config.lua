...
Config.PedCoords = vector4(389.53, -356.03, 48.02, 273.87),
Config.HiddenCoords = vector4(359.51, -326.2, 46.7, 257.41), 
Config.CamCoords = vector4(392.06, -355.75, 48.02, 95.28),
